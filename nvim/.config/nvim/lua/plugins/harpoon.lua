return {
    ...
    config = function()
        ...
        map("n", "<leader>ha", function() harpoon:list():append() end, { desc = "Add file to harpoon" })
        map("n", "<C-e>", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, { desc = "Toggle UI" })
        map("n", "<leader>h", function() harpoon:list():select(1) end, { desc = "Go to file 1" })
        map("n", "<leader>j", function() harpoon:list():select(2) end, { desc = "Go to file 2" })
        map("n", "<leader>k", function() harpoon:list():select(3) end, { desc = "Go to file 3" })
        map("n", "<leader>l", function() harpoon:list():select(4) end, { desc = "Go to file 4" })
