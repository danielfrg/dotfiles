...
vim.keymap.set("n", "<leader><space>", "<cmd>Telescope find_files hidden=true<CR>", { desc = "Find Files" })
vim.keymap.set("n", "<leader>ff", "<cmd>Telescope find_files hidden=true<CR>", { desc = "Find Files" })
vim.keymap.set("n", "<leader>fF", "<cmd>Telescope find_files hidden=true cwd=false<CR>", { desc = "Find Files (cwd)" })
vim.keymap.set("n", "<leader>fw", "<cmd>Telescope live_grep hidden=true<CR>", { desc = "Find grep" })
vim.keymap.set("n", "<leader>fW", "<cmd>Telescope grep_string hidden=true cwd=false<CR>",
...
-- File Browser
vim.keymap.set("n", "<space>fB", ":Telescope file_browser hidden=true<CR>", { desc = "File browser" })
