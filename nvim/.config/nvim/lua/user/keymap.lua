...
U.keymap("n", "<leader>c", function() require("astronvim.utils.buffer").close() end, { desc = "Close buffer" })
U.keymap("n", "<leader>C", function() require("astronvim.utils.buffer").close(0, true) end, { desc = "Force close buffer" })
