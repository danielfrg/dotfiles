...
if [ -n "$TMUX" ]; then
  ...
  printf_template='\033P\033]4;%d;rgb:%s\033\033\\\033\\'
  printf_template_var='\033P\033]%d;rgb:%s\033\033\\\033\\'
  printf_template_custom='\033P\033]%s%s\033\033\\\033\\'
else
  printf_template='\033]4;%d;rgb:%s\033\\\033\\'
  printf_template_var='\033]%d;rgb:%s\033\\\033\\'
  printf_template_custom='\033]%s%s\033\\\033\\'
fi
